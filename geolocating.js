  ...
  $('.button').on("click", function() {
    if ("geolocation" in navigator) {
      ...
      navigator.geolocation.getCurrentPosition(function(position) {
        $.getJSON("http://api.openweathermap.org/data/2.5/forecast/city?id=524901&APPID=d6dad265455539cfaba673a7f3cf6bc8", function(data) {
        ...
        //do stuff with data returned as json
          console.log(data.city.name); //moscow
        });
